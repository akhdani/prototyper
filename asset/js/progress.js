...
(function (root, factory) {
  ...
  function _setPercentFor(targetElement, percent) {
    ...
    if (targetElement.hasAttribute("data-progressjs")) {
      ...
      setTimeout(function() {
        ...
        if(percentElement) percentElement.style.width = parseInt(percent) + '%';

        var percentElement  = percentElement ? percentElement.querySelector(".progressjs-percent") : null;
        var existingPercent = percentElement ? parseInt(percentElement.innerHTML.replace('%', '')) : 0;
        ...
        (function(percentElement, existingPercent, currentPercent) {
          ...
          function changePercentTimer(percentElement, existingPercent, currentPercent) {
            ...
            if (percentElement && (existingPercent - currentPercent) != 0) {
              //set the percent
  ...
  function _increasePercent(size) {
    for (var i = 0, elmsLength = this._targetElement.length; i < elmsLength; i++) {
      ...
      if (currentElement.hasAttribute('data-progressjs')) {
        ...
        var existingPercent = percentElement ? parseInt(percentElement.style.width.replace('%', '')) : 0;
        if (existingPercent) {
  ...
  function _end() {
    ...
    var progressjsId = this._targetElement[0] ? parseInt(this._targetElement[0].getAttribute('data-progressjs')) : null;
